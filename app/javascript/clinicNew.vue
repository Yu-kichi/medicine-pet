    ...
    <div class= "box has-background-white is-shadowless">
      ...
      <div class="form__items">
        <div class="field">
          ...
          <VueMultiselect
            v-model="selectedPrefecture" :options="prefectures" track-by="name" label="name" placeholder="県名を選択してください" >
          </VueMultiselect>
...
export default {
  ...
  methods:{
    ...
    createClinic(){
      ...
      Axios.post(`/api/clinics/?pet_id=${this.petId}&prescription_id=${this.prescriptionId}`, {
        clinic: {
          name: this.name,
